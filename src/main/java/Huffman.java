...
public class Huffman {
    ...
    public static class CodedMessage {
        public ArrayList<String> trie = new ArrayList<>();
     ...
     * @return
     */
    public static CodedMessage compress(String s) {
        // read the input
        ...
        CodedMessage message = new CodedMessage();
        ...
        for (int i = 0; i < input.length; i++) {
            ...
            for (int j = 0; j < code.length(); j++) {
                if (code.charAt(j) == '0') {
                    ...
                    message.message.add(i * 2);
                    //BinaryStdOut.write(false);
                }
                else if (code.charAt(j) == '1') {
                    //System.out.println(1);
                    message.message.add(1 + i * 2);
    ...
    private static void writeTrie(Node x, ArrayList<String> output) {
        if (x.isLeaf()) {
            output.add("1"+x.ch);
//            BinaryStdOut.write(true);
